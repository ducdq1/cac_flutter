...
class InputOpenTimeWidget extends StatefulWidget {
  ...
  @override
  _InputOpenTimeWidgetState createState() => _InputOpenTimeWidgetState();
}

class _InputOpenTimeWidgetState extends State<InputOpenTimeWidget> {
  bool _readOnly = true;

  @override
  void initState() {
    //widget.hint = widget.label;
    if (widget.controller.text.isEmpty && widget.defaultValue != null) {
