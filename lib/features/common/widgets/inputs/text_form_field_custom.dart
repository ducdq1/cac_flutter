...
class TextFormFieldCustom extends FormField<String> {
  ...
  TextFormFieldCustom({
    ...
    String initialValue,
    FocusNode focusNode,
    CInputDecoration decoration = const CInputDecoration(),
    ...
    AutovalidateMode autovalidateMode,
        ...
        super(
          ...
          builder: (FormFieldState<String> field) {
            final _TextFormFieldCustomState state =
                field as _TextFormFieldCustomState;
...
class _TextFormFieldCustomState extends FormFieldState<String> {
  ...
  @override
  TextFormFieldCustom get widget => super.widget as TextFormFieldCustom;
