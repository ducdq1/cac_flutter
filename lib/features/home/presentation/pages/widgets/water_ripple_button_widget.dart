...
class WaterRippleButtonWidget extends StatefulWidget {
  final int count;
  final Color color;

  const WaterRippleButtonWidget(
      {Key key, this.count = 3, this.color = const Color(0xFF0080ff)})
      : super(key: key);

  @override
  _WaterRippleButtonWidgetState createState() => _WaterRippleButtonWidgetState();
}

class _WaterRippleButtonWidgetState extends State<WaterRippleButtonWidget>
