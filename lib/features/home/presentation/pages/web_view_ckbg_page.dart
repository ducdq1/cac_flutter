...
class WebViewPageCKBG extends StatefulWidget {
  WebViewPageCKBG({Key key, @required this.title, @required this.link})
      : super(key: key);
  final String title;
  final String link;

  @override
  _WebViewPageCKBGState createState() => _WebViewPageCKBGState();
}

class _WebViewPageCKBGState extends State<WebViewPageCKBG>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BaseLayoutWidget(
        ...
        title: 'Bảng cam kết đặt giữ hàng',
        body: Stack(
          children: [
            isLoading
