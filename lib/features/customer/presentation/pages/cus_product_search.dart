...
class SearchArgument {
  ...
  SearchArgument({this.isSaled = false,
    this.isApproveAble,
                    ...
                    child: AnimationLimiter(
                      child: GridView.count(
                        ...
                        // physics: NeverScrollableScrollPhysics(),
                          ...
                          children: _getTiles(
                              state.lstProduct, context, itemWidth,
                              itemHeight)),
                    ),
                  )
      ...
      tiles.add(
        AnimationConfiguration.staggeredList(
          ...
          child: SlideAnimation(
            verticalOffset: 50.0,
            child: FadeInAnimation(child: GridTile(
              child: InkWell(
                onTap: () {
                  Navigator.pushNamed(context, ROUTER_DETAILED_PAHT,
                      arguments:
                        ...
                        child: Padding(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                Row(mainAxisAlignment: model.productType > 1 ? MainAxisAlignment
                                    .spaceBetween : MainAxisAlignment
                                    .end, children: [
                                  Text(
                                    model.productType <= 1  ? '': model.size??'',
                                    style: GoogleFonts.inter(
                                        color: Colors.orange,
                                        fontSize: 12,
