...
import 'package:citizen_app/features/customer/presentation/widgets/promotion_item_widget.dart';
...
class _ListViewPromotionWidgetState extends State<ListViewPromotionWidget> {
...
class ListViewPromotionWidget extends StatefulWidget {
  final List<PromotionModel> promotions;
  final ScrollController scrollController;
  ListViewPromotionWidget({@required this.promotions,@required  this.scrollController});

  @override
  _ListViewPromotionWidgetState createState() =>
      _ListViewPromotionWidgetState();
}
